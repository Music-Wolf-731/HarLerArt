    ...
    <div id="PageDisplay">
        ...
        if (isset($_SESSION['Visitor']) && $_SESSION['Visitor'] == 'company') {
            ...
            $PaneArr = [
                ...
                ['你說我是特別的訪客是甚麼意思？', '哈，您是被註記的貴賓呢，沒意外的話應該是公司的貴客，又或是前輩吧？\',\'是的，你們的身份不一樣，看見的問題也會不一樣\',\'這是我的個人網站，未來也會有不同的展示用途，會給予不同的人觀看\',\'而我並不希望每個人都知道我全方位的資料，所以用了入口標記的方式將使用者區隔開來，說得專業點是用PHP的session\',\'若您要將您看到的這個頁展示給其它人，請使用以下網趾，直接複製目前網站的網址的話會少掉很多重要資料的哦(我以後會做一鍵複製的功能的，再等等我吧)\',\'https://localhost/NetIndex/?Visit=work'],
